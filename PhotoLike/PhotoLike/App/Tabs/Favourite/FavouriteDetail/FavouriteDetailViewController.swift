...
class FavouriteDetailViewController: BaseViewController {
    enum Constants {
    ...
    // MARK: - Properties
    private let viewModel: FavouriteDetailViewModelProvider
    private let input = PassthroughSubject<FavouriteDetailViewModelInput, Never>()
    ...
    // MARK: - Initialization
    init(viewModel: FavouriteDetailViewModelProvider) {
    ...
    // MARK: Binding
    private func bind(viewModel: FavouriteDetailViewModelProvider) {
